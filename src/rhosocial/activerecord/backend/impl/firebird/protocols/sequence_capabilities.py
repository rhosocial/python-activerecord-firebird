# firebird/protocols/sequence_generated.py
...
class FirebirdSequenceSupport(Protocol):
    """Auto-generated capability protocol (P7)."""

    def format_create_sequence(self, sequence_name: str, start_value: int=1, increment: int=1, use_generator: bool=False) -> Tuple[str, tuple]:
        ...  # pragma: no cover
