# tests/rhosocial/activerecord_firebird_test/feature/backend/dialect/test_dialect_branches.py
"""Offline dialect SQL branch snapshots for the Firebird dialect.

Covers the RETURNING / SKIP LOCKED / SEQUENCE dialect branches and CREATE
TABLE rebuild-statement rendering from mixins/table.py — all via exact
to_sql() snapshots with no database connection.
"""
import pytest
